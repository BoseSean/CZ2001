...
int main() {
    ...
    std::cout<<std::setw(10)<<"Data size"<<std::setw(15)<<"Time use"<<std::setw(30)<<"Comparison"<<std::endl;
...
void printValues(int size, int merge_time, int insert_time, int merge_compare, int insert_compare ){
    ...
    std::cout<<std::setw(15)<<merge_compare;
    std::cout<<std::setw(15)<<insert_compare<<std::endl;
}
static std::vector<int> generate_random_vector(int size, int max){
